    ...
    #[OAT\Post(
        ...
        responses: [
            new OAT\Response(
                ...
                description: 'Return Sanctum Token',
                content: new OAT\JsonContent(type: 'object', properties: [
                    new OAT\Property(property: 'token', type: 'string', description: 'id|token', example: '1|token'),
                ]),
            ),
